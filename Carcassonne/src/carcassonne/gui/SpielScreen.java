...
//		spielfeld.attachChild(geo);
	 ...
	 * <ol>
	 * <li>Map "pick target" action to a MouseButtonTrigger.
	 * <li>flyCam.setEnabled(false);
	 * <li>inputManager.setCursorVisible(true);
	 * <li>Implement action in AnalogListener (TODO).
	 * </ol>
	 */
